#!/usr/bin/env bash
# ------------------------------------------------------------------------------
# rôle        : inventorie et archive les scripts non référencés du dépôt
# usage       : ./scripts/menage-scripts.sh [--archive-unreferenced --apply]
# contexte    : maintenance du dépôt
# dépendances : bash, grep, awk, sha256sum
# statut      : actif
# ------------------------------------------------------------------------------
